                ...
                <section class="content">
				        ...
				        <div class="box">
					        <div class="box-header with-border">
						          ...
						          <a href="{{route('post.create')}}" class="btn btn-success col-lg-offset-5"><i class="fa fa-plus"></i>Add New</a>
						                                    ...
						                                    <tr>
						                                        ...
						                                        <td>
                                                                    ...
                                                                    @if(request()->session()->get('groubid')!==0)
                                                                        <a href="{{route('post.edit',$post->id)}}"><i class="glyphicon glyphicon-edit" onclick="return false" style="color: grey"></i></a>
                                                                    @else
